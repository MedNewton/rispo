...
import image1 from '@/assets/visions/1.webp';
import image2 from '@/assets/visions/2.webp';
import image3 from '@/assets/visions/3.webp';
import image4 from '@/assets/visions/4.webp';
import image5 from '@/assets/visions/5.webp';
import image6 from '@/assets/visions/6.webp';
import image7 from '@/assets/visions/7.webp';
import image8 from '@/assets/visions/8.webp';
import image9 from '@/assets/visions/9.webp';
import image10 from '@/assets/visions/10.webp';
import image11 from '@/assets/visions/11.webp';
...
export default function Content() {
  ...
  return (
    <div className='flex flex-col items-start justify-start gap-4'>
      <h1 className='font-bold' style={{fontSize: '3.5rem'}}>{t('category2Title')}</h1>
